...
export function ProjectsSection() {
  return (
    <section id="projekty" className="py-24 px-8 md:px-16 max-w-screen-2xl mx-auto">
      ...
      {/* Grid — featured vlevo, dva menší vpravo */}
      <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gridTemplateRows: 'auto auto', gap: 10 }}>

        {/* Featured — Rashid — spans 2 rows */}
        <motion.div
